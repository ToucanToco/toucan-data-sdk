...
def sample_filter_data():
    return [
        ...
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't1', 'played': 15, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'ord': 10, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'clap clap',
         'date': 't1', 'played': 5, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't1', 'played': 10, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't2', 'played': 17, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't2', 'played': 20, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Tom', 'category_id': 'tom', 'product_id': 'bom',
         'date': 't2', 'played': 50, 'filterA': 'mickey', 'filterB': 'dodo'},
        # filterA = 'donald',   filterB = 'dodo'
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't1', 'played': 12, 'filterA': 'donald', 'filterB': 'dodo'},
        {'ord': 10, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'clap clap',
         'date': 't1', 'played': 1, 'filterA': 'donald', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't1', 'played': 1, 'filterA': 'donald', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't2', 'played': 10, 'filterA': 'donald', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't2', 'played': 100, 'filterA': 'donald', 'filterB': 'dodo'},
        {'ord': 1, 'category_name': 'Tom', 'category_id': 'tom', 'product_id': 'bom',
         'date': 't2', 'played': 1, 'filterA': 'donald', 'filterB': 'dodo'},
        # filterA = 'mickey',   filterB = 'dada'
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't1', 'played': 15, 'filterA': 'mickey', 'filterB': 'dada'},
        {'ord': 10, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'clap clap',
         'date': 't1', 'played': 5, 'filterA': 'mickey', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't1', 'played': 10, 'filterA': 'mickey', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't2', 'played': 17, 'filterA': 'mickey', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't2', 'played': 20, 'filterA': 'mickey', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Tom', 'category_id': 'tom', 'product_id': 'bom',
         'date': 't2', 'played': 50, 'filterA': 'mickey', 'filterB': 'dada'},
        # filterA = 'donald',   filterB = 'dada'
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't1', 'played': 12, 'filterA': 'donald', 'filterB': 'dada'},
        {'ord': 10, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'clap clap',
         'date': 't1', 'played': 1, 'filterA': 'donald', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't1', 'played': 1, 'filterA': 'donald', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Clap', 'category_id': 'clap', 'product_id': 'super clap',
         'date': 't2', 'played': 10, 'filterA': 'donald', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Snare', 'category_id': 'snare', 'product_id': 'tac',
         'date': 't2', 'played': 100, 'filterA': 'donald', 'filterB': 'dada'},
        {'ord': 1, 'category_name': 'Tom', 'category_id': 'tom', 'product_id': 'bom',
         'date': 't2', 'played': 1, 'filterA': 'donald', 'filterB': 'dada'},
    ]
...
def test_waterfall_filter_simple(sample_filter_data):
    ...
    expected = [
        # mickey
        {'groups': 'Trimestre 1', 'label': 'Trimestre 1', 'type': nan,
         'value': 30.0, 'variation': nan, 'order': nan, 'filterA': 'mickey'},
        {'groups': 'bom', 'label': 'bom', 'type': 'parent',
         'value': 50.0, 'variation': inf, 'order': 1.0, 'filterA': 'mickey'},
        {'groups': 'super clap', 'label': 'super clap', 'type': 'parent',
         'value': 2.0, 'variation': 0.13333333333333333, 'order': 1.0, 'filterA': 'mickey'},
        {'groups': 'tac', 'label': 'tac', 'type': 'parent',
         'value': 10.0, 'variation': 1.0, 'order': 1.0, 'filterA': 'mickey'},
        {'groups': 'clap clap', 'label': 'clap clap', 'type': 'parent',
         'value': -5.0, 'variation': -1.0, 'order': 10.0, 'filterA': 'mickey'},
        {'groups': 'Trimester 2', 'label': 'Trimester 2', 'type': nan,
         'value': 87.0, 'variation': nan, 'order': nan, 'filterA': 'mickey'},
        # donald
        {'groups': 'Trimestre 1', 'label': 'Trimestre 1', 'type': nan,
         'value': 14.0, 'variation': nan, 'order': nan, 'filterA': 'donald'},
        {'groups': 'bom', 'label': 'bom', 'type': 'parent',
         'value': 1.0, 'variation': inf, 'order': 1.0, 'filterA': 'donald'},
        {'groups': 'super clap', 'label': 'super clap', 'type': 'parent',
         'value': -2.0, 'variation': -0.16666666666666666, 'order': 1.0, 'filterA': 'donald'},
        {'groups': 'tac', 'label': 'tac', 'type': 'parent',
         'value': 99.0, 'variation': 99.0, 'order': 1.0, 'filterA': 'donald'},
        {'groups': 'clap clap', 'label': 'clap clap', 'type': 'parent',
         'value': -1.0, 'variation': -1.0, 'order': 10.0, 'filterA': 'donald'},
        {'groups': 'Trimester 2', 'label': 'Trimester 2', 'type': nan,
         'value': 111.0, 'variation': nan, 'order': nan, 'filterA': 'donald'}
    ]
...
def test_waterfall_filter_two_col(sample_filter_data):
    ...
    expected = [
        # mickey - dodo
        {'groups': 'Trimestre 1', 'label': 'Trimestre 1', 'type': nan,
         'value': 30.0, 'variation': nan, 'order': nan, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'groups': 'bom', 'label': 'bom', 'type': 'parent',
         'value': 50.0, 'variation': inf, 'order': 1.0, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'groups': 'super clap', 'label': 'super clap', 'type': 'parent',
         'value': 2.0, 'variation': 0.13333333333333333, 'order': 1.0,
         'filterA': 'mickey', 'filterB': 'dodo'},
        {'groups': 'tac', 'label': 'tac', 'type': 'parent',
         'value': 10.0, 'variation': 1.0, 'order': 1.0, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'groups': 'clap clap', 'label': 'clap clap', 'type': 'parent',
         'value': -5.0, 'variation': -1.0, 'order': 10.0, 'filterA': 'mickey', 'filterB': 'dodo'},
        {'groups': 'Trimester 2', 'label': 'Trimester 2', 'type': nan,
         'value': 87.0, 'variation': nan, 'order': nan, 'filterA': 'mickey', 'filterB': 'dodo'},
        # donald - dodo
        {'groups': 'Trimestre 1', 'label': 'Trimestre 1', 'type': nan,
         'value': 14.0, 'variation': nan, 'order': nan, 'filterA': 'donald', 'filterB': 'dodo'},
        {'groups': 'bom', 'label': 'bom', 'type': 'parent',
         'value': 1.0, 'variation': inf, 'order': 1.0, 'filterA': 'donald', 'filterB': 'dodo'},
        {'groups': 'super clap', 'label': 'super clap', 'type': 'parent',
         'value': -2.0, 'variation': -0.16666666666666666, 'order': 1.0,
         'filterA': 'donald', 'filterB': 'dodo'},
        {'groups': 'tac', 'label': 'tac', 'type': 'parent',
         'value': 99.0, 'variation': 99.0, 'order': 1.0, 'filterA': 'donald', 'filterB': 'dodo'},
        {'groups': 'clap clap', 'label': 'clap clap', 'type': 'parent',
         'value': -1.0, 'variation': -1.0, 'order': 10.0, 'filterA': 'donald', 'filterB': 'dodo'},
        {'groups': 'Trimester 2', 'label': 'Trimester 2', 'type': nan,
         'value': 111.0, 'variation': nan, 'order': nan, 'filterA': 'donald', 'filterB': 'dodo'},
        # mickey - dada
        {'groups': 'Trimestre 1', 'label': 'Trimestre 1', 'type': nan,
         'value': 30.0, 'variation': nan, 'order': nan, 'filterA': 'mickey', 'filterB': 'dada'},
        {'groups': 'bom', 'label': 'bom', 'type': 'parent',
         'value': 50.0, 'variation': inf, 'order': 1.0, 'filterA': 'mickey', 'filterB': 'dada'},
        {'groups': 'super clap', 'label': 'super clap', 'type': 'parent',
         'value': 2.0, 'variation': 0.13333333333333333, 'order': 1.0,
         'filterA': 'mickey', 'filterB': 'dada'},
        {'groups': 'tac', 'label': 'tac', 'type': 'parent',
         'value': 10.0, 'variation': 1.0, 'order': 1.0, 'filterA': 'mickey', 'filterB': 'dada'},
        {'groups': 'clap clap', 'label': 'clap clap', 'type': 'parent',
         'value': -5.0, 'variation': -1.0, 'order': 10.0, 'filterA': 'mickey', 'filterB': 'dada'},
        {'groups': 'Trimester 2', 'label': 'Trimester 2', 'type': nan,
         'value': 87.0, 'variation': nan, 'order': nan, 'filterA': 'mickey', 'filterB': 'dada'},
        # donald - dada
        {'groups': 'Trimestre 1', 'label': 'Trimestre 1', 'type': nan,
         'value': 14.0, 'variation': nan, 'order': nan, 'filterA': 'donald', 'filterB': 'dada'},
        {'groups': 'bom', 'label': 'bom', 'type': 'parent',
         'value': 1.0, 'variation': inf, 'order': 1.0, 'filterA': 'donald', 'filterB': 'dada'},
        {'groups': 'super clap', 'label': 'super clap', 'type': 'parent',
         'value': -2.0, 'variation': -0.16666666666666666, 'order': 1.0,
         'filterA': 'donald', 'filterB': 'dada'},
        {'groups': 'tac', 'label': 'tac', 'type': 'parent',
         'value': 99.0, 'variation': 99.0, 'order': 1.0, 'filterA': 'donald', 'filterB': 'dada'},
        {'groups': 'clap clap', 'label': 'clap clap', 'type': 'parent',
         'value': -1.0, 'variation': -1.0, 'order': 10.0, 'filterA': 'donald', 'filterB': 'dada'},
        {'groups': 'Trimester 2', 'label': 'Trimester 2', 'type': nan,
         'value': 111.0, 'variation': nan, 'order': nan, 'filterA': 'donald', 'filterB': 'dada'}
    ]
